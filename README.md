...
1. Set the configuration appropriate to your needs and select **Create**.
    ...
    ![image.png](./images/ado-newproject.png)
...
1. Once created, select **Repos** from the options available (as we are going to be selecting our GitHub example repo mentioned previously.
    ...
    ![image.png](./images/ado-welcome.png)
...
1. Select **Import**.
    ...
    ![image.png](./images/ado-import.png)
...
1. Select **Project settings** on the main page (lower left).
    ...
    ![image.png](./images/ado-projectsettings.png)
...
1. **Save** to continue.
    ...
    ![image.png](./images/ado-newserviceconnection.png)
...
1. **Select Pipelines / Create Pipeline.**
    ...
    ![image.png](./images/ado-firstpipeline.png)

1. Select **Azure Repos Git** (YAML).

    ![image.png](./images/ado-selectazurerepo.png)

1. Select the **AzureDiagnostics** repo (or other name if you renamed it upon import).

    ![image.png](./images/ado-selectazurerepodiags.png)

1. Select **Existing Azure Pipelines YAML** file from the options available.

    ![image.png](./images/ado-configurepipeline.png)
...
![image.png](./images/ado-reviewpipeline.png)
...
If you want to change how the policies are built, according to your target environment, you’ll want to review the script options at [https://aka.ms/AzPolicyScripts](https://aka.ms/AzPolicyScripts) and customize the below section accordingly (specifically -AllRegions)
```
...
![image.png](./images/ado-diagpolicyvars.png)
...
![image.png](./images/ado-targetenvvars.png)
...
![image.png](./images/ado-serviceconnectionowner.png)
...
![image.png](./images/policyinitiview.png)
...
![image.png](./images/policyinitiviewpolicies.png)
...
![image.png](./images/policyremediated.png)
...
![image.png](./images/serviceconnection-rightserror.png)
...
![image.png](./images/serviceconnection-rightserrorgit.png)
